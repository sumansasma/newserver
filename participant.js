...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchEvents() {
        try {
            const response = await fetch('https://participate-in-event.onrender.com/api/events');
    ...
    async function fetchParticipants(eventId) {
        try {
            const url = `https://participate-in-event.onrender.com/api/participants/${eventId}`;
    ...
    participantForm.addEventListener('submit', async function (e) {
        ...
        if (eventId.trim() !== '' && participantName.trim() !== '' && participantPhone.trim() !== '') {
            const url = 'https://participate-in-event.onrender.com/api/participants'; // Replace with the actual server address and port
